...
const showProducts = (products) => {
    ...
    for (const product of allProducts) {
        ...
        <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn" class="buy-now btn btn-danger text-whites">Add to Cart</button>
        <button id="details-btn" onclick="getSingleProduct(${product.id})" class="btn btn-info text-dark">Details</button>
...
//    display product function
   const ShowSingleProduct = product => {
    ...
    <p> <i class="fas fa-star text-danger"> ${product.rating.rate} </i> 
     <i class="fas fa-user"> ${product.rating.count} </i> </p>
    <h4>Price : $ ${product.price}</h4>
    <button onclick="addToCart(${product.id},${product.price})" id="addToCart-btn"
    class="buy-now btn btn-dark text-white">Add to Cart</button>
    </div>
    </div>
    `;
    }
